...
- **SPX_Options_raw.csv** (~3.5 GB)
- **SPX_Forward_Prices.csv** (~100 MB)
...
mv ~/Downloads/SPX_Options_raw.csv data/raw/
mv ~/Downloads/SPX_Forward_Prices.csv data/raw/
...
├── data/
│   └── raw/
│       ├── SPX_Options_raw.csv              ← Place here
│       ├── SPX_Forward_Prices.csv           ← Place here
│       └── treasury_3month_rates.csv        ← Place here
└── ...
```
...
**Pipeline stages:**
1. Data preprocessing & BS baseline (~15 min)
...
- Ensure all 3 CSV files are in `data/raw/`
- Check: `ls data/raw/`
